...
def rf_specific_county(path_to_data, split_number, county):
    """
    ...
    classes_dataframe = county_df.loc[:, ['IdClassEsp']]
    features_dataframe['IdClassEsp'] = classes_dataframe.iloc[:, 0].values
...
rf_specific_county('/home/naroairirarte/Desktop/prueba_rf/test.txt', 2, 'V')
